...
module.exports.run = async (bot,message,args) => {
  ...
  if(!args[0]){
    ...
    .setAuthor("FALLEGA BOT's commands list")
  ...
  if(args[0] == "addrole"){
    ...
    .addField("Example", [
      "`" + `${prefix}addrole @FALLEGA TEAM owner` + "` adds the role 'owner' to '@FALLEGA TEAM'."
    ]);
  ...
  if(args[0] == "ban"){
    ...
    .addField("Example", [
      "`" + `${prefix}ban @FALLEGA TEAM he was bad` + "` bans the user '@FALLEGA TEAM' with the reason",
      "'he was bad'."
    ]);
  ...
  if(args[0] == "kick"){
    ...
    .addField("Example", [
      "`" + `${prefix}kick @FALLEGA TEAM he was bad` + "` kicks the user '@FALLEGA TEAM' with the reason",
      "'he was bad'."
    ]);
  ...
  if(args[0] == "purge"){
    ...
    .addField("Example", [
      "`" + `${prefix}removerole @FALLEGA TEAM owner` + "` removes the role 'owner' from '@FALLEGA TEAM'"
    ]);
  ...
  if(args[0] == "tempmute"){
    ...
    .addField("Example", [
      "`" + `${prefix}tempmute @FALLEGA TEAM 10m he was bad` + "` mutes '@FALLEGA TEAM' for '10 minutes'",
  ...
  if(args[0] == "warn"){
    ...
    .addField("Example", [
      "`" + `${prefix}warn @FALLEGA TEAM he was bad` + "` warns '@FALLEGA TEAM' with the reason",
      "'he was bad'"
    ]);
  ...
  if(args[0] == "warnlevel"){
    ...
    .addField("Examples", [
      ...
      "`" + `${prefix}warnlevel @FALLEGA TEAM` + "` display @FALLEGA TEAM's warn level"
    ]);
  ...
  if(args[0] == "avatar"){
    ...
    .addField("Examples", [
      ...
      "`" + `${prefix}avatar @FALLEGA TEAM` + "` display @FALLEGA TEAM's avatar"
    ]);
  ...
  if(args[0] == "level"){
    ...
    .addField("Examples", [
      ...
      "`" + `${prefix}level @FALLEGA TEAM` + "` display @FALLEGA TEAM's level"
    ]);
  ...
  if(args[0] == "prefix"){
    ...
    .addField("Example", [
      "`" + `${prefix}report @FALLEGA TEAM he was bad` + "` reports '@FALLEGA TEAM' with the reason",
      "'he was bad'"
    ]);
  ...
  if(args[0] == "insult"){
    ...
    .addField("Example", [
      "`" + `${prefix}insult @FALLEGA TEAM` + "` insults @FALLEGA TEAM"
    ]);
  ...
  if(args[0] == "pay"){
    ...
    .addField("Example", [
      "`" + `${prefix}pay @FALLEGA TEAM 100` + "` give @FALLEGA TEAM 100 coins"
    ]);
  ...
  if(args[0] == "fortnite"){
    ...
    .addField("Example", [
      "`" + `${prefix}fortnite FALLEGA TEAM pc solo` + "` displays stats of FALLEGA TEAM on pc on solo."
    ]);
